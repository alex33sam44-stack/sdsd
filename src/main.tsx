...
// Drain any user contributions that previous sessions queued locally but never
// pushed to the backend (e.g. offline, or API was down). Fire-and-forget; the
// helper is a no-op when VITE_API_BASE_URL is not configured.
import("./modules/shared/services/userContributions")
  .then(({ retryPendingContributions }) => retryPendingContributions())
  .catch(() => undefined);
