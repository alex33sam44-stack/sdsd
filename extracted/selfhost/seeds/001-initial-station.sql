...
INSERT INTO stations (id, tenant_id, city_id, name, area, lat, lng, is_published, created_at, updated_at)
VALUES (@station_id, @tenant_id, @city_id, 'موقف رمسيس', 'وسط القاهرة', 30.0626, 31.2497, 1, NOW(), NOW())
ON DUPLICATE KEY UPDATE
  tenant_id = VALUES(tenant_id),
